          ...
          <el-row>
            <el-col>
              <el-form-item label="选择曲线" label-width="100px">
                <el-select v-model="temp.curveId" placeholder="请选择曲线" style="width: 80%" :disabled="jinZhiXuanZe">
            ...
            <el-table-column label="操作" align="center" width="300px" class-name="small-padding fixed-width">
              <template slot-scope="scope">
                <el-button
                  type="text"
                  size="big"
                  @click="curveHomologySheZhi(scope.$index, curveHomologyList)"
                >设置
                </el-button>
                <el-button
                  type="text"
        ...
        <el-form ref="dataForm" :model="temp" label-position="left" label-width="90px" style="border:1px solid black;border-left:0;width:100%;padding:10px 5px;height:600px;position: relative;">
          <el-row style="height:45%">
            ...
            <el-scrollbar style="height:100%">
              ...
              <el-col :span="4">
                <el-button icon="el-icon-circle-plus" style="margin-top:80px;padding:0;font-size:60px;color:black;background:#fff;border:0;" circle="true" @click="addMessage" />
              </el-col>
            </el-scrollbar>
          </el-row>
          <hr>
          <el-row style="height:45%">
            ...
            <el-scrollbar style="overflow-x: hidden;height:100%">
              ...
              <el-col :span="4">
                <el-button icon="el-icon-circle-plus" style="margin-top:80px;padding:0;font-size:60px;color:black;background:#fff;border:0;" circle="true" @click="addMessage2" />
              </el-col>
            </el-scrollbar>
          </el-row>
          <el-form-item>
