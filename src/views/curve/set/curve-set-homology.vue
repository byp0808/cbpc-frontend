  ...
  <div class="app-container">
    ...
    <el-table :data="curveHomologyDtoList" tooltip-effect="dark" style="width: 100%">
      ...
      <el-table-column label="同调曲线" width="290px" align="center">
        <template slot-scope="scope">
          <span class="link-type" @click="curveHomologyDtoEdit(scope.$index, curveHomologyDtoList, 'VIEW')">详情</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" align="center" width="230px" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button v-else type="text" size="big" @click="curveHomologyDtoEdit(scope.$index, curveHomologyDtoList, 'EDIT')">
            编辑
          </el-button>
...
export default {
  ...
  methods: {
    ...
    // dto列表修改操作
    curveHomologyDtoEdit(index, rows, opType) {
      this.opType = opType
