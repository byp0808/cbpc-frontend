        ...
        <el-card class="box-card margin-top">
          ...
          <el-row>
            <el-col :span="12">
              ...
              <el-form-item v-if="normalInfo.cdsPremAdjType === '01'" label="调整值">
                <el-input-number v-model="normalInfo.cdsAdjValue" :min="1"/>
              </el-form-item>
              <template v-else-if="normalInfo.cdsPremAdjType === '02'">
                <el-form-item label="初始点差">
                  <el-input-number v-model="normalInfo.cdsSpread" :min="1" :max="10" @change="handleChange" />
                </el-form-item>
                <el-form-item label="最终点差">
                  <el-input-number v-model="normalInfo.cdsTarget" :min="1" :max="10" @change="handleChange" />
                </el-form-item>
                <el-form-item label="调整幅度">
                  <el-input-number v-model="normalInfo.cdsAdjValue" :min="1" :max="10" @change="handleChange" />
                </el-form-item>
              </template>
            </el-col>
            <el-col :span="12">
              <el-form-item label="相对点差">
                <el-input-number style="width: 100%" v-model="normalInfo.relaSpread" :min="1" :max="10" @change="handleChange" />
              </el-form-item>
              <el-form-item>
                <el-button type="primary">选择市场价格</el-button>
              </el-form-item>
      ...
      <el-col :span="10">
        <el-card class="box-card margin-top">
          ...
          <el-form-item label="目标流动性点差">
            <el-input-number v-model="normalInfo.flAdjValue" :min="1" :max="10" @change="handleChange" />
          </el-form-item>
          <el-form-item label="目标其他点差">
            <el-input-number v-model="normalInfo.otAdjValue" :min="1" :max="10" @change="handleChange" />
          </el-form-item>
        </el-card>
        <el-card class="box-card margin-top">
          <el-form-item label="">
